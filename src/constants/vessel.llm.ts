...
For each ownership type (Beneficial owner, Registered owner, Technical Manager, ISM manager, Commercial controller, Commercial manager (in the data has the value "manager"), Operator) include: 
...
-If any of the companies is more than one owner type: group it together
